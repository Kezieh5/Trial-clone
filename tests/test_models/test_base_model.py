...
class Test_BaseModel(unittest.TestCase):
    ...
    def test_all_str(self):
        ...
        self.assertIn("[BaseModel] (456789)", Bmodel_str)
        self.assertIn("'id': '456789'", Bmodel_str)
    ...
    def test_kwargs(self):
        ...
        Bmodel = BaseModel(id="12345", created_at=date_iso, updated_at=date_iso)
        self.assertEqual(Bmodel.id, "12345")
